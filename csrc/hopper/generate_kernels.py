...
def main(output_dir: Optional[str | Path]) -> None:
    output_dir = Path(output_dir) if output_dir is not None else Path(__file__).parent / "gpu" / "instantiations"
